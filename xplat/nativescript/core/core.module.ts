...
import { throwIfAlreadyLoaded } from '@qarun-qb/utils';
...
export class QarunQbCoreModule {
  constructor(
    @Optional()
    @SkipSelf()
    parentModule: QarunQbCoreModule
  ) {
    throwIfAlreadyLoaded(parentModule, 'QarunQbCoreModule');
  }
}
